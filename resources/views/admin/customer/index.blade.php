                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-md-3">
                                <div class="form-group mb-3 ">
                                    ...
                                    <input class="form-control" name="filter_title" type="text" value="{{ $common['filter_title']  }}" placeholder="{{ translate('Enter Name') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="status" name="filter_status" class="form-select single-select" data-allow-clear="true">
                                        <option value=""  > {{ translate('All') }}</option>
                                        <option value="Active" {{ getSelected('Active', $common['filter_status']) }}> {{ translate('Active') }}</option>
                                        <option value="Inactive" {{ getSelected('Inactive', $common['filter_status']) }}>{{ translate('Inactive') }}</option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('admin.customer.view', encrypt($value['id'])) }}">
                                                    <i class="bx bx-edit-alt me-1"></i> 
                                                    {{ translate('View') }}
                                                </a>

                                                <a class="dropdown-item" href="{{ route('admin.customer.delete', encrypt($value['id'])) }}">
                                                    <i class="bx bx-edit-alt me-1"></i> 
                                                    {{ translate('Delete') }}
                                                </a>
                                            </div>
