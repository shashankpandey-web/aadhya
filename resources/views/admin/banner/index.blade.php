    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card shadow mb-4">
             <div class="card-header">
                ...
                <a href="{{ route('admin.banners.add') }}" class="dt-button create-new btn btn-primary float-end">
