...
<head>
    ...
    <title>Delete Account | AADYA APP</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="confirm-delete-form" class="mb-3" method="post" action="" >
                            ...
                            <button class="btn btn-primary d-grid w-100" type="submit"> {{ translate('Delete Account') }}
