    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-md-3">
                            <div class="form-group mb-3 ">
                                ...
                                <input class="form-control" name="filter_category_title" type="text" value="{{ $common['filter_category_title']  }}" placeholder="{{ translate('Enter title') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <select id="status" name="filter_category_status" class="form-select single-select" data-allow-clear="true">
                                    <option value="Active" {{ getSelected('Active', $common['filter_category_status']) }}> {{ translate('Active') }}</option>
                                    <option value="Deactive" {{ getSelected('Deactive', $common['filter_category_status']) }}>{{ translate('Deactive') }}</option>
                                </select>
                            </div>
                        </div>
        ...
        <div class="card shadow mb-4">
             <div class="card-header">
                ...
                <a href="{{ route('admin.categories.add') }}" class="dt-button create-new btn btn-primary float-end">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.categories.add', encrypt($value['id'])) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> {{ translate('Edit') }}</a>
                                                <a class="dropdown-item confirm-delete" href="javascript:void(0);"
                                                    data-href="{{ route('admin.categories.delete', encrypt($value['id'])) }}"><i
